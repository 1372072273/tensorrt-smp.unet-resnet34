...
IResizeLayer* upsample(INetworkDefinition* network,ITensor& input ) {
...
ICudaEngine* createEngine(unsigned int maxBatchSize, IBuilder* builder, IBuilderConfig* config, DataType dt)
{
    ...
    std::map<std::string, Weights> weightMap = loadWeights("../prj1.wts");
    Weights emptywts{ DataType::kFLOAT, nullptr, 0 };
    ...
    IResizeLayer* resize1 = upsample(network, *identity7->getOutput(0));
